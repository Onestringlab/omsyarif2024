        ...
        <div class="card-body">
            @if($action == 'insert')
                <form class="form-horizontal" action="{{ asset('/') }}salaries" method="post">
                    ...
                    <div class="mb-3 row">
                        <label for="p1" class="col-sm-2 col-form-label"><strong>Simp. Wajib Koperasi</strong></label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" name="p1" value="0">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="p2" class="col-sm-2 col-form-label"><strong>Simp. Sukarela Koperasi</strong></label>
                        <div class="col-sm-10">
            ...
            @elseif($action == 'delete')
                <form class="form-horizontal" action="{{ asset('/') }}salaries/{{ $row->id }}"
                    ...
                    <div class="mb-3 row">
                        <label for="p1" class="col-sm-2 control-label"><strong>Simp. Wajib Koperasi</strong></label>
                        <div class="col-sm-10">
                            {{ toCurrency($row->p1) }}
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="p2" class="col-sm-2 control-label"><strong>Simp. Sukarela Koperasi</strong></label>
                        <div class="col-sm-10">
                            {{ toCurrency($row->p2) }}
                        </div>
                    </div>
