...
<div class="container">
    ...
    <script>
        function button_cancel() {
            location.replace("{{ asset('/') }}salary-shortages/data/{{ $month_id }}");
        }
    </script>
    ...
    <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{asset('/')}}salary-shortages/data/{{ $month_id }}">Kekurangan Gaji</a>
            </li>
    ...
    <div class="card border-success">
        <h5 class="card-header text-bg-success">Kekurangan Gaji</h5>
        ...
        <div class="card-body">
            ...
            <form class="form-horizontal" action="{{ asset('/') }}salary-shortages" method="post">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="nmpeg" required>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Gaji Pokok</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan Istri</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan Anak</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan UPNS</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan Struktural</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan Fungsional</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan Daerah</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan Terpencil</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan Lain</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan Kompen</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Pembulatan</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan Beras</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Tunjangan PPH</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Total Tunjangan</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Kotor</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>potpfkbul</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>potpfk2</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>potpfk10</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>potpph</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>potswrum</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>bpjs</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>bpjs2</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Total Potongan</strong></label>
                    <div class="col-sm-10">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><strong>Gaji Bersih</strong></label>
                    <div class="col-sm-10">
            ...
            <form class="form-horizontal" action="{{ asset('/') }}salary-shortages/{{ $row->id }}" method="post">
            ...
            <form class="form-horizontal" action="{{ asset('/') }}salary-shortages/{{ $row->id }}" method="post">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 control-label"><strong>Gaji Bersih</strong></label>
                    <div class="col-sm-10">
