...
<head>
    ...
    <title>Slip Kekurangan Gaji</title>
    <style>
        body {
            font-size: small;
            margin: 20px;
...
<body>
    ...
    <div class="payslip-container">
        <h3>
            <center>SLIP KEKURANGAN GAJI</center>
        </h3>
        <table class="table-bordered">
            ...
            <tr>
                ...
                <td width="10px">:</td>
                <td>Kekurangan gaji yang dibayarkan pada {{ $row->months->month }} {{ $row->months->year }}</td>
            </tr>
            <tr>
                <td>Nama</td>
                <td>:</td>
    ...
    @php
    $counter++;
    if ($counter % 2 == 0 && $counter < count($rows))
        {
