...
<div class="row mb-3">
    <div class="col-md-6">
        ...
        <tr><th>Golongan</th><td>{{ $pegawai->golongan }} {{ $pegawai->nama_golongan }}</td></tr>
    ...
    <div class="col-md-6">
        <table class="table table-borderless mb-0">
        <tr><th style="width:160px">Kd Anak</th><td>{{ $pegawai->kdanak }}</td></tr>
...
<div class="row mb-3">
    <div class="col-md-6">
        <table class="table table-borderless mb-0">
        <tr><th style="width:160px">Tahun Gapok</th><td>{{ $pegawai->tahungapok }}</td></tr>
        <tr><th>Kd BPJS2</th><td>{{ $pegawai->kdbpjs2 }}</td></tr>
        <tr><th>Bulan Akhir</th><td>{{ $pegawai->bulanakhir }}</td></tr>
        <tr><th>Tahun Akhir</th><td>{{ $pegawai->tahunakhir }}</td></tr>
        </table>
    </div>
    <div class="col-md-6">
        <table class="table table-borderless mb-0">
